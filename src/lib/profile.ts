...
export { defaultCommentAvatarUrl, defaultLogoUrl } from "@/lib/branding";
export { defaultPromotionImage } from "@/lib/promotion";
export type AuthorProfile = { id?: string; name: string; bio: string; avatarUrl: string; linkedinUrl: string; promotionImage: string; logoUrl: string; commentAvatarUrl: string };
export const defaultAuthorProfile: AuthorProfile = { name: "Belhachemia Mohammed", bio: "Personal writing, research and practical perspectives from Algeria.", avatarUrl: "https://founder.brintiel.com/static/images/profile-pic.png", linkedinUrl: "https://www.linkedin.com", promotionImage: defaultPromotionImage, logoUrl: defaultLogoUrl, commentAvatarUrl: defaultCommentAvatarUrl };
