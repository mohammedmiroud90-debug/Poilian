...
const copy: Record<Locale, Copy> = {
  en: { nav: ["Home", "Blog posts", "Companies", "Personal notes", "Photography", "About me"], contact: "Contact", subscribe: "Subscribe", market: "Market", title: <>Belhachemia, this is<br />my personal corner.</>, subtitle: "Stories, thoughts, photography and the moments worth remembering.", posts: "View all posts", services: "Services", search: "Search posts", menu: "Open menu" },
