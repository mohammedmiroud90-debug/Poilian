...
export function HomeHero() {
  ...
  return <section className="personal-hero poilian-locale-copy" dir={locale === "ar" ? "rtl" : "ltr"}><div className="personal-shell">
    ...
    {searchOpen && <form className="hero-search" onSubmit={submit}><input value={query} onChange={(event) => setQuery(event.target.value)} autoFocus placeholder={text.search} /><button>{text.search}</button></form>}
